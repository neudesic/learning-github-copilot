...
2. **Ask about an entire file**
   ...
   - For example, "What is the purpose of this file?" or "How does this module fit into the overall architecture?"
     ...
     1. As long as you have the file open, copilot will automatically suggest adding the file to the chat. You will notice if you switch between files, the chat will update to reflect the file you are currently in.
        - make sure to select the italicized text that appears in the chat panel to add the file context.
