...
- Ensure the model is set to **GPT-4.1** in the settings for best results.

---

### 2️⃣ Ask Contextual Questions About the React Component

- Browse to `sample-code/SimpleFullStack/Web/src/ui/components/product/ProductCard.tsx` and open the file.
...
### 3️⃣ Understand the Application Architecture
...
### 4️⃣ Get Help with API Integration
...
### 6️⃣ Ask for Component Improvements
