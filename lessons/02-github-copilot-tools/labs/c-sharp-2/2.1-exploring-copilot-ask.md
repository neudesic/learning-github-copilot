...
- Ensure the model is set to **GPT-41** in the settings for best results.

---

### 2️⃣ Ask Contextual Questions

- Browse to `samples-code/Orders/Orders.Api/Controllers` folder and open the `OrderController.cs` file.
