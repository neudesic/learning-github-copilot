...
**Project Folder:**  
[Orders Project](../../../../sample-code/Orders/Readme.md)
...
- Ensure you have a clean version of `sample-code/Orders/Orders.Domain/Order.cs` open for editing.

---

### 2️⃣ Launch Copilot Edit
...
### 3️⃣ Add the File to Context

- Click `+ Add Files` and select the `sample-code/Orders/Orders.Domain/Order.cs` file from your project to add it to the edit context.

---

### 4️⃣ Issue a Refactoring Prompt
...
Copilot Edit will now scan the full file and apply necessary updates across the class. Review the proposed changes directly in the chat interface.
