...
For other platforms, see the instructions [GitHub command line tool](https://github.com/cli/cli?tab=readme-ov-file#installation).
...
- [Lesson 1: Development with GitHub Copilot](../_schedule/01-github_copilot.md)
