...
- **#codebase**: Flexible search tool, works in all chat modes (Ask, Agent), can be combined with other operations
...
![Model Selection Guide](../images/ModelSelection.png)
...
**[🌐 Explore GitHub Platform Features →](../github-copilot-web-features.md)**
