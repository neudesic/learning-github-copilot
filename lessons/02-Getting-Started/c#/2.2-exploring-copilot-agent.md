...
**📝 Evolution from Copilot Edits:**
Agent mode represents the evolution of the previous Copilot Edits feature, offering enhanced capabilities including:
...
- **Legacy access** - Edits mode remains available by unchecking "Enable agent mode" in Visual Studio 2022 v17.14+
